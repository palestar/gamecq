...
public:
	...
	static BOOL			m_bToolbarWrapMode;
...
protected:
	...
	BOOL OnShowCustomizePane(CBCGPopupMenu* /*pMenuPane*/, UINT uiToolbarID);
	...
	void ShowQuickCustomizePane(CBCGPopupMenu* pMenuPopup);
	void AddDefaultButtonsToCustomizePane(CBCGPopupMenu* pMenuPane, UINT uiToolbarID);
	BOOL IsCustomizePane(const CBCGPopupMenu* pMenuPopup) const;

	LRESULT ProcessMenuAcc (WPARAM wParam, LPARAM lParam, CBCGPopupMenu* pMenu);
};
