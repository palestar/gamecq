...
protected:
	...
	CSize						m_sizeImage;
	CBCGToolBarImages			m_Image;
	CBCGToolBarImages			m_ImageHot;
	CBCGToolBarImages			m_ImageDisabled;
	CBCGToolBarImages			m_ImageChecked;
	CBCGToolBarImages			m_ImageCheckedHot;
	CBCGToolBarImages			m_ImageCheckedDisabled;
