...
public:
    ...
    static void SetForceShadow (BOOL bValue = TRUE)
    {
...
protected:
	...
	afx_msg LRESULT OnAccHitTest (WPARAM wParam, LPARAM lParam);
	afx_msg	LRESULT OnAccGetState (WPARAM wParam, LPARAM lParam);
	DECLARE_MESSAGE_MAP()
};
