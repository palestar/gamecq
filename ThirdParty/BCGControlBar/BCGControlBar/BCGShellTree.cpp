...
IMPLEMENT_DYNAMIC(CBCGShellTree, CTreeCtrl)

IContextMenu2* CBCGShellTree::m_pContextMenu2 = NULL;

CBCGShellTree::CBCGShellTree()
{
	m_bContextMenu = TRUE;
...
BEGIN_MESSAGE_MAP(CBCGShellTree, CTreeCtrl)
	//{{AFX_MSG_MAP(CBCGShellTree)
	ON_WM_CREATE()
...
/////////////////////////////////////////////////////////////////////////////
// CBCGShellTree message handlers

int CBCGShellTree::OnCreate(LPCREATESTRUCT lpCreateStruct) 
{
...
//***************************************************************************************
void CBCGShellTree::SetRelatedList (CBCGShellList* pShellList)
{
	ASSERT_VALID (this);
...
//***************************************************************************************
CBCGShellList* CBCGShellTree::GetRelatedList () const
{
	ASSERT_VALID (this);
	...
	CBCGShellList* pList = DYNAMIC_DOWNCAST (CBCGShellList,
		CWnd::FromHandlePermanent (m_hwndRelatedList));

	return pList;
}
//****************************************************************************************
void CBCGShellTree::Refresh ()
{
	ASSERT_VALID (this);
...
//***************************************************************************************
BOOL CBCGShellTree::GetRootItems ()
{
	ASSERT_VALID (this);
...
//***************************************************************************************
BOOL CBCGShellTree::GetChildItems (HTREEITEM hParentItem)
{
	ASSERT_VALID (this);
...
//***************************************************************************************
HRESULT CBCGShellTree::EnumObjects (HTREEITEM		hParentItem,
...
//***************************************************************************************
int CALLBACK CBCGShellTree::CompareProc(LPARAM lParam1, LPARAM lParam2, LPARAM lParamSort)
{
...
//****************************************************************************************
void CBCGShellTree::OnShowContextMenu (CPoint point)
{
...
//***************************************************************************************
CString CBCGShellTree::OnGetItemText (LPBCGCBITEMINFO pItem)
{
	ASSERT (pItem != NULL);
	SHFILEINFO sfi;
...
//***************************************************************************************
int CBCGShellTree::OnGetItemIcon (LPBCGCBITEMINFO pItem, BOOL bSelected)
{
	ASSERT (pItem != NULL);
	SHFILEINFO sfi;
...
//****************************************************************************************
void CBCGShellTree::OnItemexpanding (NMHDR* pNMHDR, LRESULT* pResult) 
{
...
//****************************************************************************************
void CBCGShellTree::OnDeleteitem(NMHDR* pNMHDR, LRESULT* pResult) 
{
	ASSERT_VALID (g_pShellManager);
...
//****************************************************************************************
void CBCGShellTree::OnContextMenu(CWnd* /*pWnd*/, CPoint point) 
{
	if (m_bContextMenu)
	{
...
//****************************************************************************************
BOOL CBCGShellTree::SelectPath (LPCTSTR lpszPath)
{
	ASSERT_VALID (this);
	ASSERT_VALID (g_pShellManager);
...
//***************************************************************************************
BOOL CBCGShellTree::SelectPath (LPCITEMIDLIST lpidl)
{
	BOOL bRes = FALSE;
...
//****************************************************************************************
BOOL CBCGShellTree::GetItemPath (CString& strPath, HTREEITEM htreeItem) const
{
	ASSERT_VALID (this);
...
//***************************************************************************************
void CBCGShellTree::OnRButtonDown(UINT /*nFlags*/, CPoint point) 
{
	SetFocus ();
	SelectItem (HitTest (point));
}
//***************************************************************************************
void CBCGShellTree::EnableShellContextMenu (BOOL bEnable)
{
	m_bContextMenu = bEnable;
}
//******************************************************************************************
BOOL CBCGShellTree::OnChildNotify(UINT message, WPARAM wParam, LPARAM lParam, LRESULT* pLResult) 
{
	if (message == WM_NOTIFY && !m_bNoNotify)
	{
		...
		{
			CBCGShellList* pRelatedShellList = GetRelatedList ();
...
//***************************************************************************************
void CBCGShellTree::OnDestroy() 
{
	CBCGShellList* pList = GetRelatedList ();
	if (pList != NULL)
	{
...
//*********************************************************************************
LRESULT CBCGShellTree::WindowProc(UINT message, WPARAM wParam, LPARAM lParam) 
{
	switch (message)
	{
...
//*********************************************************************************
void CBCGShellTree::PreSubclassWindow() 
{
...
//**********************************************************************************
void CBCGShellTree::SetFlags (DWORD dwFlags, BOOL bRefresh)
{
	ASSERT_VALID (this);
	m_dwFlags = dwFlags;
