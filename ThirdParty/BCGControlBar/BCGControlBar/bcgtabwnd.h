...
public:
	...
	BOOL IsTabIconOnly(int iTab) const;
	BOOL SetTabIconOnly(int iTab, BOOL bIconOnly = TRUE, BOOL bShowTooltipAlways = FALSE);
	...
	virtual void InvalidateTab (int iTab);
...
extern BCGCONTROLBARDLLEXPORT UINT BCGM_ON_BEFOREMOVE_TAB;
