...
BCGCONTROLBARDLLEXPORT extern UINT BCGM_RESETRPROMPT;
...
class BCGCONTROLBARDLLEXPORT CBCGToolBar : public CControlBar
{
	...
	friend class CBCGCustomizeMenuButton;
...
public: 
	...
	static CBCGToolBarImages* GetMenuImages ()
	{
		return &m_MenuImages;
	}
	...
	static CBCGToolBarImages* GetColdImages ()
	{
		return &m_ColdImages;
	}
	static CBCGToolBarImages* GetDisabledImages ()
	{
		return &m_DisabledImages;
	}
	static CBCGToolBarImages* GetLargeImages ()
	{
		return &m_LargeImages;
	}
	static CBCGToolBarImages* GetLargeColdImages ()
	{
		return &m_LargeColdImages;
	}
	static CBCGToolBarImages* GetLargeDisabledImages ()
	{
		return &m_LargeDisabledImages;
	}
	static CBCGToolBarImages* GetDisabledMenuImages ()
	{
		return &m_DisabledMenuImages;
	}
	const CBCGToolBarImages* GetLockedMenuImages () const
	{
		if (!m_bLocked)
		{
			ASSERT (FALSE);
	...
	BOOL IsExistCustomizeButton() const
	{
...
public:
	...
	CBCGToolbarButton* InvalidateButton(int nIndex);
...
protected:
	...
	void SaveResetOriginalState (CBCGRegistry& reg);
	BOOL LoadResetOriginalState (CBCGRegistry& reg);
