...
public:
	...
	void DrawIcon (CDC* pDC, CRect rect, BOOL bHorz, BOOL bMaximized, BOOL bDisabled);
...
public:
	...
	static BOOL IsCaptionAlwaysOnTop ()
	{
		return m_bCaptionAlwaysOnTop;
	}
...
protected:
	...
	CRect GetGripperRect (const CRect& rcClient, BOOL bIncludeButtons);
	void ReposCaptionButtons ();
...
protected:
	...
	static BOOL		m_bCaptionAlwaysOnTop;
